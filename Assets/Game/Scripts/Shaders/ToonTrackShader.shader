Shader "Tank/ToonTrackShader"
{
    Properties
    {
        ...
        _TrackSpeed         ("Track Speed", Float)                = 0.0
        _TrackDirection     ("Track Direction", Vector)           = (0,1,0,0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes input)
            {
                ...
                // Анимация UV для имитации движения гусениц
                float2 animatedUV = input.uv;
                animatedUV += _TrackDirection.xy * _TrackSpeed * _Time.y;
