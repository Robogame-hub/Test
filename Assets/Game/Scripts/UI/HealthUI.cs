...
namespace TankGame.UI
{
    ...
    public class HealthUI : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (tankHealth == null)
            {
                Debug.LogError("[HealthUI] TankHealth not assigned! Assign manually in Inspector.");
                return;
            }
            ...
            Debug.Log($"[HealthUI] Initialized! Health: {tankHealth.CurrentHealth}/{tankHealth.MaxHealth}, TextComponent: {(healthText != null ? "Text" : (healthTextTMP != null ? "TextMeshPro" : "None"))}");
        }
        ...
        private void UpdateHealthDisplay(float currentHealth, float maxHealth)
        {
            ...
            else if (healthTextTMP != null)
            {
                ...
                Debug.Log($"[HealthUI] Updated TextMeshPro: {healthString}");
            }
            else
            {
