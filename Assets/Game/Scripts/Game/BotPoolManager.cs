...
{
    /// <summary>
    /// ѕул ботов: настраиваемое количество, спавн-поинты.
    ///  аждый бот закрепл€етс€ за своим спавн-поинтом; после смерти респавнитс€ в том же поинте.
    /// </summary>
    public class BotPoolManager : MonoBehaviour
    {
        ...
        [Tooltip("≈сли запуск из лобби в режиме одиночной игры, использовать количество ботов из сессии")]
        [SerializeField] private bool useSessionSoloBotCount = true;
        [Tooltip("Ќе спавнить ботов, если матч запущен как лобби-комната")]
        ...
        private void ResolveBotCountFromSession()
        {
            ...
            {
                botCount = Mathf.Max(1, GameSessionSettings.SoloBotCount);
            }
        }
